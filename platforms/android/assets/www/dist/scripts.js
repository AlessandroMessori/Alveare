...
/***/ function(module, exports, __webpack_require__) {
	...
	var _credentials = __webpack_require__(181);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _deletePosts = __webpack_require__(8);

	var _deletePosts2 = _interopRequireDefault(_deletePosts);

	var _likes = __webpack_require__(9);

	var _likes2 = _interopRequireDefault(_likes);

	var _moderation = __webpack_require__(10);

	var _moderation2 = _interopRequireDefault(_moderation);

	var _readReports = __webpack_require__(11);

	var _readReports2 = _interopRequireDefault(_readReports);

	var _reportBug = __webpack_require__(12);

	var _reportBug2 = _interopRequireDefault(_reportBug);

	var _updateProfile = __webpack_require__(13);

	var _updateProfile2 = _interopRequireDefault(_updateProfile);

	var _updateStatus = __webpack_require__(14);

	var _updateStatus2 = _interopRequireDefault(_updateStatus);
	...
	barComponents.controller("reportBugCtrl", _reportBug2.default);
	barComponents.controller("updateProfileCtrl", _updateProfile2.default);
	barComponents.controller("updateStatusCtrl", _updateStatus2.default);
...
/***/ function(module, exports) {
	...
	var readReportsCtrl = function readReportsCtrl($scope, Reports) {
	    _classCallCheck(this, readReportsCtrl);

	    Reports.getReports($scope, "reportsSpinner");
	};

	exports.default = readReportsCtrl;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var reportBugCtrl = function reportBugCtrl($scope, $ionicLoading, Reports, DateHandler, Modals) {
	    _classCallCheck(this, reportBugCtrl);

	    $scope.$on("$ionicView.enter", function () {
	        return $scope.formScope.news = "";
	    });

	    $scope.setReportScope = function (scope) {
	        return $scope.formScope = scope;
	    };
...
/***/ function(module, exports) {
	...
	var updateProfileCtrl = function updateProfileCtrl($scope, $rootScope, $state, Profile, CameraHandler) {
	    ...
	    $scope.goToUpdateStatus = function () {
	        if ($rootScope.profileUpdatable) {
...
/***/ function(module, exports) {
	...
	var updateStatusCtrl = function updateStatusCtrl($scope, $rootScope, $ionicLoading, Profile) {
	    _classCallCheck(this, updateStatusCtrl);

	    $scope.sendStatus = function (newStatus) {
	        $ionicLoading.show({
	...
	exports.default = updateStatusCtrl;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var tabsCtrl = function tabsCtrl($scope, $state, $rootScope, $ionicPlatform, $ionicScrollDelegate, $ionicHistory, Auth, PlatformHandler) {
	    ...
	    $scope.goToProfile = function () {
	        ...
	        var avatar = _firebase2.default.auth().currentUser.photoURL;
	        ...
	        $rootScope.currentProfile = {
	            name: _firebase2.default.auth().currentUser.displayName,
	            avatar: avatar,
	            mail: _firebase2.default.auth().currentUser.email
	        };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _conventions = __webpack_require__(22);
	...
	var _newsCtrl = __webpack_require__(25);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Comments = __webpack_require__(61);

	var _Comments2 = _interopRequireDefault(_Comments);

	var _Likes = __webpack_require__(62);
	...
	var _Reports = __webpack_require__(157);
	...
	var _StaticData = __webpack_require__(159);
	...
	dataServices.service("Reports", _Reports2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Articles = function Articles($ionicLoading, StringHandler, Modals, FileHandler) {
	                        ...
	                        strRef.child("img").getDownloadURL().then(function (imgUrl) {
	                            ...
	                            strRef.child("pdf").getDownloadURL().then(function (pdfUrl) {
	                                ...
	                                _firebase2.default.storage().ref("Profili").child(results[item].userMail).getDownloadURL().then(function (url) {
	                                    _this.setArticleProperties(scope, rootScope, state, articles, results[item], item, i, imgUrl, pdfUrl, url, keys.length, spinner);
	                                }).catch(function () {
	                                    var defaultImage = "dist/Images/user.png";
	                                    _this.setArticleProperties(scope, rootScope, state, articles, results[item], item, i, imgUrl, pdfUrl, defaultImage, keys.length, spinner);
	                                });
	                            });
	                        });
	                    });
	    ...
	    this.setArticleProperties = function (scope, rootScope, state, articles, results, item, index, imgUrl, pdfUrl, url, length, spinner) {
	        articles[index] = {
	            title: results.title,
	            ...
	            linkToProfile: function linkToProfile() {
	                rootScope.currentProfile = {
	                    name: results.author,
	                    avatar: url,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _includes = __webpack_require__(33);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var toFinite = __webpack_require__(45);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Comments = function Comments(Likes) {
	            ...
	            if (results != null) {
	                Object.keys(results).map(function (item, i) {
	                    if (!filter) {
	                        ...
	                        _firebase2.default.storage().ref("Profili").child(results[item].userMail).getDownloadURL().then(function (url) {
	                            return _this.setCommentProperties(scope, rootScope, state, comments, results, url, i, item, spinner);
	                        }).catch(function () {
	                            return _this.setCommentProperties(scope, rootScope, state, comments, results, "dist/Images/user.png", i, item, spinner);
	                        });
	                    }
	                });
	            }
	    ...
	    this.setCommentProperties = function (scope, rootScope, state, comments, results, url, index, item, spinner) {
	        comments.push({
	            author: results[item].author,
	            avatar: url,
	            text: results[item].comment,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _uniqBy = __webpack_require__(63);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Messages = function Messages(Modals, Comments, Likes) {
	                        ...
	                        results[item].files.map(function (file, j) {
	                            ...
	                            stRef.child(file).getDownloadURL().then(function (url) {
	                                ...
	                                if (j == results[item].files.length - 1) {
	                                    _firebase2.default.storage().ref("Profili").child(results[item].userMail).getDownloadURL().then(function (url) {
	                                        return self.setPostProperties(results, files, state, posts, scope, rootScope, item, i, maxLength, url);
	                                    }).catch(function () {
	                                        return self.setPostProperties(results, files, state, posts, scope, rootScope, item, i, maxLength, "dist/Images/user.png");
	                                    });
	                                }
	                            });
	                        });
	    ...
	    this.setPostProperties = function (results, files, state, posts, scope, rootScope, item, i, maxLength, url) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Reports = function Reports(Modals) {
	    _classCallCheck(this, Reports);

	    this.sendReport = function (newData) {

	        var newPostKey = _firebase2.default.database().ref().child("Segnalazioni").push().key;

	        var updates = {};
	        updates["/Segnalazioni/" + newPostKey] = newData;
	        _firebase2.default.database().ref().update(updates).then(function () {
	            return Modals.ResultTemplate("Grazie Della Segnalazione!");
	        }).catch(function () {
	            return Modals.ResultTemplate("Errore nell' Invio della Segnalazione");
	        });
	    };

	    this.getReports = function (scope, spinner) {

	        document.getElementById(spinner).style.display = "block";

	        var ModelRef = _firebase2.default.database().ref("Segnalazioni");
	        ModelRef.on("value", function (snapshot) {
	            var results = snapshot.val();
	            var reports = [];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Profile = function Profile($ionicLoading, FileHandler, Modals) {
	    ...
	    this.updateStatus = function (newStatus, profile) {

	        var updates = {};
	        updates["/Stati/" + profile] = newStatus;
	        _firebase2.default.database().ref().update(updates).then(function () {
	            return Modals.ResultTemplate("Stato Aggiornato");
	        }).catch(function () {
	            return Modals.ResultTemplate("Impossibile Aggiornare lo Stato");
	        });
	    };

	    this.getStatus = function (userName, scope) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _pull = __webpack_require__(166);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseRest = __webpack_require__(167),
	    pullAll = __webpack_require__(169);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var basePullAll = __webpack_require__(170);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var arrayMap = __webpack_require__(50),
	    baseIndexOf = __webpack_require__(34),
	    baseIndexOfWith = __webpack_require__(171),
	    baseUnary = __webpack_require__(127),
...
/***/ function(module, exports) {
	...
	var CameraHandler = function () {
	    ...
	    _createClass(CameraHandler, [{
	        key: "getPic",
	        value: function getPic(callback, Modals) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".fileName {\n  margin-left: 5%;\n  font-size: 14px; }\n\n#cameraBtn {\n  background-color: transparent !important; }\n\n#img_1 {\n  margin-left: 20%;\n  max-width: 60%;\n  height: auto; }\n\n#img-preview {\n  display: none; }\n\n#upload-pdf {\n  display: block;\n  width: 100px;\n  height: 20px;\n  overflow: hidden;\n  margin-top: 10px; }\n  #upload-pdf button {\n    width: 110px;\n    height: 30px;\n    position: relative;\n    top: -5px;\n    left: -5px; }\n    #upload-pdf button span {\n      font-size: 20px; }\n  #upload-pdf input {\n    font-size: 50px;\n    width: 120px;\n    opacity: 0;\n    filter: alpha(opacity=0);\n    position: relative;\n    top: -40px;\n    left: -20px; }\n\n#pdfList {\n  list-style-type: circle;\n  margin: 2% 10%; }\n  #pdfList li {\n    font-size: 14px; }\n    #pdfList li span.icon {\n      color: red; }\n\n.fixed-outside {\n  position: absolute;\n  bottom: 0;\n  color: white;\n  width: 100%;\n  text-align: center; }\n\n#commentList {\n  margin: 0; }\n  #commentList .title {\n    color: blue; }\n  #commentList .text {\n    color: black;\n    display: inline; }\n  #commentList span {\n    font-size: 13px; }\n\n.deleteBtn {\n  float: right;\n  font-size: 20px;\n  margin-top: 2%; }\n\n.paddingTop {\n  margin-top: 10%; }\n\n.offsetY {\n  margin-top: 5%; }\n\n.reportDate {\n  text-align: right !important; }\n\n.sendReportRow {\n  margin-top: 3%;\n  text-align: center; }\n\n.profileBg {\n  background-color: #4286f4;\n  margin-top: 43px;\n  padding: 3%;\n  text-align: center; }\n  .profileBg img {\n    border: 5px solid white;\n    border-radius: 50%;\n    width: 40vw;\n    height: 40vw; }\n  .profileBg h2, .profileBg h4 {\n    color: white; }\n\n.dataRow {\n  padding: 0; }\n  .dataRow h4 {\n    color: white; }\n  .dataRow .first {\n    background-color: #4271f4; }\n  .dataRow .second {\n    background-color: #0c60ee; }\n\n.infoList {\n  padding: 0 3%; }\n  .infoList input[readonly], .infoList textarea[readonly] {\n    background-color: white; }\n\n.loginSection {\n  text-align: center; }\n  .loginSection .item {\n    margin-top: 5%; }\n  .loginSection .row {\n    text-align: center; }\n  .loginSection #inputrow {\n    margin-top: 2%; }\n  .loginSection #btnrow {\n    margin-top: 5%; }\n  .loginSection #checkboxrow {\n    margin-top: 2%;\n    text-align: left; }\n  .loginSection .responsive {\n    width: 40%;\n    height: auto;\n    text-align: center;\n    margin-top: 12%; }\n\n.bar-positive .button {\n  border-color: transparent; }\n\n.bar-positive {\n  background-color: #164A80 !important; }\n  .bar-positive .title {\n    text-align: center !important; }\n\n.button {\n  background-color: #164A80 !important; }\n\n.sideMenu, .navList a.item-content, #drawer, .bar {\n  background-color: #164A80;\n  color: white; }\n\n.navList a.item-content {\n  font-size: 18px; }\n\n#drawer {\n  width: 80%; }\n\n.bar h1 {\n  color: white !important; }\n\n#sideMenuHeader {\n  background-color: #164A80; }\n  #sideMenuHeader * {\n    color: white !important; }\n\n#adminPanel {\n  display: none; }\n\n#linkList {\n  padding-left: 10%;\n  display: none; }\n  #linkList li {\n    margin-top: 2%; }\n\n.iconBar {\n  font-size: 16px; }\n\n#addIcon {\n  display: none; }\n\n#showLinks {\n  float: right; }\n\n#linkItem {\n  background-color: #164A80;\n  color: white; }\n\n.linkItem {\n  width: 100%; }\n\n.bar-positive .button {\n  border-color: transparent; }\n\n.bar-positive {\n  background-color: #164A80 !important; }\n  .bar-positive .title {\n    text-align: center !important; }\n\n.button {\n  background-color: #164A80 !important; }\n\n.sideMenu, .navList a.item-content, #drawer, .bar {\n  background-color: #164A80;\n  color: white; }\n\n.navList a.item-content {\n  font-size: 18px; }\n\n#drawer {\n  width: 80%; }\n\n.bar h1 {\n  color: white !important; }\n\n#sideMenuHeader {\n  background-color: #164A80; }\n  #sideMenuHeader * {\n    color: white !important; }\n\n#adminPanel {\n  display: none; }\n\n#linkList {\n  padding-left: 10%;\n  display: none; }\n  #linkList li {\n    margin-top: 2%; }\n\n.iconBar {\n  font-size: 16px; }\n\n#addIcon {\n  display: none; }\n\n#showLinks {\n  float: right; }\n\n#linkItem {\n  background-color: #164A80;\n  color: white; }\n\n.linkItem {\n  width: 100%; }\n\n.scrollView {\n  background-color: #E9EBEE !important; }\n\n.item-image img {\n  max-height: 350px; }\n\n.article-header {\n  display: inline-flex;\n  width: 100%; }\n  .article-header .right {\n    margin-left: 40%; }\n\n.spinner {\n  position: absolute;\n  margin-top: 20%;\n  right: 50%;\n  transform: translateX(50%); }\n\n.author {\n  color: blue !important; }\n\n.date {\n  text-align: right; }\n\n.fileList {\n  margin-bottom: 3%;\n  margin-left: 3%; }\n  .fileList li span {\n    font-size: 18px;\n    display: inline; }\n  .fileList li p {\n    font-size: 13px;\n    color: #387EF5;\n    display: inline; }\n  .fileList li a {\n    font-size: 13px; }\n\n.dataTag {\n  font-size: 13px; }\n\n.actionIcon {\n  margin: 0.5%;\n  text-align: center;\n  font-size: 15px;\n  color: darkslategrey; }\n\ndrawer {\n  display: block;\n  position: fixed;\n  width: 50%;\n  height: 100%;\n  z-index: 100;\n  background-color: white; }\n\ndrawer.animate {\n  -webkit-transition: 300ms all ease;\n  transition: 300ms all ease; }\n\ndrawer.left {\n  -webkit-transform: translate3d(-100%, 0, 0);\n  transform: translate3d(-100%, 0, 0);\n  box-shadow: 1px 0px 10px rgba(0, 0, 0, 0.3); }\n\ndrawer.right {\n  right: 0;\n  top: 0;\n  -webkit-transform: translate3d(100%, 0, 0);\n  transform: translate3d(100%, 0, 0);\n  box-shadow: -1px 0px 10px rgba(0, 0, 0, 0.3); }\n", ""]);
